...
# Если работать с ними, то лучше увеличить и уменьшать в % соотношении
oneCharWidth = 9
oneCharHeight = 16

# Указываем и открываем саму картинку
im = Image.open(input())

# Указываем какой шрифт и размер шрифта хочется для ASCII-art-a 
fnt = ImageFont.truetype('C:\\Windows\\Fonts\\lucon.ttf', 15)

# Чутка шаманим с размерами и загружаем пиксели самой картинки
...
# однако всё это можно поправить и исправить под нужды юзера.
