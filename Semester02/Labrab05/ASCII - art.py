...
# Если очень сильно хочется картинку в высокой детализации(то есть когда scaleFactor больше 0.5), 
# то стоит разбить программу на класс с методами и через
# компилятор Numba всё вкусно сделать что бы фото не обрабатывалось 20 часов,
